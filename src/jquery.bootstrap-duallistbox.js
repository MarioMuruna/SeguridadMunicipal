(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoTextFiltered: '<span class="badge badge-warning">Filtro</span> {0} from {1}', // when not all of the options are visible due to the filter
      ...
      btnMoveText: 'agregar',                                                                // string, sets the text for the "Move" button
      btnRemoveText: 'quitar',                                                              // string, sets the text for the "Remove" button
      btnMoveAllText: 'agregar todos',                                                         // string, sets the text for the "Move All" button
      btnRemoveAllText: 'quitar todos'                                                        // string, sets the text for the "Remove All" button
    },
